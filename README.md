...
Fraga is a social fitness application that helps users track their workouts, connect with friends, and stay motivated through social features. The app is built using Android native development with Java and follows modern Android development practices.
